...
from fhir_types import identifier, human_name, contact_point, address, codeable_concept, attachment, reference, period, timing, annotation, meta_type, id_type, implicitRules_type, language_type, text_type, contained_type, extension_type, modifierExtension_type, range_type, quantity, money, coding

# COMMAND ----------

# DBTITLE 1,ExplanationOfBenefit Schema
...
df = spark.read.format("json")\
    .schema(explanation_of_benefit_schema)\
    .load("s3://healthcare-analytics-bucket-042740341370-us-east-1-an/bulk-fhir-data/7-7-2026/ExplanationOfBenefit.ndjson")
